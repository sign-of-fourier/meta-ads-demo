  ...
  return (
    <div style={s.page}>
      <div style={s.inner}>
        ...
        {/* Hero — D variant */}
        <h1 style={s.h1}>
          Stop guessing which ad wins. Run a real experiment.
        </h1>
        <p style={s.sub}>
          AdStackers uses Bayesian optimization to guide your next test — analyzing
          content, audience, and performance history across every platform you run.
        </p>

        {/* CTAs */}
        <div style={s.ctaRow}>
          <a href="/app/auth" style={s.btnPrimary}>Run your first experiment</a>
        ...
        <div style={s.howCard}>
          ...
          <h2 style={s.howH2}>Every test you run without a system is budget you won't get back.</h2>
          <div style={s.howSteps}>
            <div style={s.step}>
              <div style={s.stepNum}>01</div>
              <div style={s.stepLabel}>Define what you're testing</div>
              <div style={s.stepDesc}>Set up the creative space — headlines, images, offers, angles. The model needs a universe to search.</div>
            </div>
            <div style={s.step}>
              <div style={s.stepNum}>02</div>
              <div style={s.stepLabel}>Get the next best test, explained</div>
              <div style={s.stepDesc}>AdStackers ranks every candidate and tells you which one to run next — and exactly what signal drove the pick.</div>
            </div>
            <div style={s.step}>
              <div style={s.stepNum}>03</div>
              <div style={s.stepLabel}>The model learns. You pull ahead.</div>
              <div style={s.stepDesc}>Results feed back in. The next recommendation is sharper. The gap between you and teams guessing widens.</div>
            </div>
          </div>
        ...
        {/* Feature cards — reordered: BO first, then research, then beta */}
        <div style={s.grid3}>
          <div style={s.card}>
            <h3 style={s.cardHead}>Smarter tests, not more tests</h3>
            <p style={s.cardBody}>
              Random A/B testing doesn't learn. Bayesian optimization scores every
              candidate against your history and picks the one most likely to win —
              before you spend a dollar on it.
            </p>
          </div>

          <div style={s.card}>
            <h3 style={s.cardHead}>The data is clear</h3>
            <p style={s.cardBody}>
              Meta's own research found that firms running structured experiments
              show higher subsequent ad performance. The advantage isn't one-time — it
          ...
          <div style={s.card}>
            ...
            <p style={s.cardBody}>
              Full access, no credit card, no limits. The teams building this
              habit now will be the ones hardest to catch later.
            </p>
          </div>
        </div>
